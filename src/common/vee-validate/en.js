export default {
  ...
  messages: {
    ...
    decimal: function(e, n) {
      ...
      var t = n[0];
      return void 0 === t && (t = "*"),
      "The " + e + " field must be numeric and may contain " + (t && "*" !== t ? t : "") + " decimal points."
    },
    digits: function(e, n) {
    ...
    size: function(e, n) {
      var t, i, a, r = n[0];
      return "The " + e + " size must be less than " + (t = r,
          i = 1024,
          a = 0 == (t = Number(t) * i) ? 0 : Math.floor(Math.log(t) / Math.log(i)),
        1 * (t / Math.pow(i, a)).toFixed(2) + " " + ["Byte", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][a]) + "."
    },
    url: function(e) {
